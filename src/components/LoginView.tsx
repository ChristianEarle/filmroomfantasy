...
export function LoginView({ onLogin, onSwitchToRegister, onForgotPassword, isDarkMode = true }: LoginViewProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" onClick={() => onForgotPassword?.()} className="text-sm text-blue-500 hover:text-blue-400 transition-colors">Forgot password?</button>
              </div>
              <div className={inputWrap}>
